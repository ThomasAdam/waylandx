...
struct _RenderFuncs {
	...
	void (*fill_boxes_with_transparency)(RenderTarget, pixman_box32_t *,
	    int, int, int);
	...
	/* Composite width, height, from the given buffer onto the given
	   ...
	   being composited.  */
	void (*composite)(RenderBuffer, RenderTarget, Operation, int, int, int,
	    int, int, int, DrawParams *);
	...
	PresentCompletionKey (*present_to_window)(RenderTarget, RenderBuffer,
	    pixman_region32_t *, PresentCompletionFunc, void *);

	/* Call the specified render callback once it is time to display the
	   next frame.  May be NULL.  */
	RenderCompletionKey (
	    *notify_msc)(RenderTarget, RenderCompletionFunc, void *);
...
struct _BufferFuncs {
	...
	RenderBuffer (*buffer_from_single_pixel)(uint32_t, uint32_t, uint32_t,
	    uint32_t, Bool *);
...
extern void RegisterStaticRenderer(const char *, RenderFuncs *, BufferFuncs *);
...
extern void RenderFillBoxesWithTransparency(RenderTarget, pixman_box32_t *, int,
    int, int);
extern void RenderClearRectangle(RenderTarget, int, int, int, int);
extern void RenderComposite(RenderBuffer, RenderTarget, Operation, int, int,
    int, int, int, int, DrawParams *);
extern RenderCompletionKey RenderFinishRender(RenderTarget, pixman_region32_t *,
    RenderCompletionFunc, void *);
...
extern void XLScaleRegion(pixman_region32_t *, pixman_region32_t *, float,
    float);
extern void XLExtendRegion(pixman_region32_t *, pixman_region32_t *, int, int);
...
extern void XLCreateRegion(struct wl_client *, struct wl_resource *, uint32_t);
...
extern void	   *XLBufferRunOnFree(ExtBuffer *, ExtBufferFunc, void *);
...
extern void SubcompositorSetOpaqueCallback(Subcompositor *,
    void (*)(Subcompositor *, void *, pixman_region32_t *), void *);
...
extern void SubcompositorSetNoteFrameCallback(Subcompositor *,
    void (*)(FrameMode, uint64_t, void *, uint64_t, uint64_t), void *);
...
extern void ViewSetViewport(View *, double, double, double, double, double,
    double);
...
#define RotatesDimensions(transform)                                          \
	((transform) == CounterClockwise90 ||                                 \
	    (transform) == CounterClockwise270 || (transform) == Flipped90 || \
...
struct _RoleFuncs {
	...
	void (*activate)(Surface *, Role *, int, Timestamp, Surface *);
};
...
extern void XLCreateSurface(struct wl_client *, struct wl_resource *, uint32_t);
...
extern CommitCallback *XLSurfaceRunAtCommit(Surface *,
    void (*)(Surface *, void *), void *);
extern void	       XLSurfaceCancelCommitCallback(CommitCallback *);
extern UnmapCallback  *XLSurfaceRunAtUnmap(Surface *, void (*)(void *), void *);
extern void	       XLSurfaceCancelUnmapCallback(UnmapCallback *);
extern DestroyCallback *XLSurfaceRunOnFree(Surface *, void (*)(void *), void *);
extern void		XLSurfaceCancelRunOnFree(DestroyCallback *);
extern void  *XLSurfaceGetClientData(Surface *, ClientDataType, size_t,
     void (*)(void *));
...
extern Atom _NET_WM_OPAQUE_REGION, _XL_BUFFER_RELEASE,
    ...
    WM_PROTOCOLS, _NET_SUPPORTING_WM_CHECK, _NET_SUPPORTED,
    _NET_WM_SYNC_REQUEST, _MOTIF_WM_HINTS, _NET_WM_STATE_MAXIMIZED_VERT,
    _NET_WM_STATE_MAXIMIZED_HORZ, _NET_WM_STATE_FOCUSED,
    _NET_WM_STATE_FULLSCREEN, _NET_WM_STATE, _NET_WM_MOVERESIZE,
    _GTK_FRAME_EXTENTS, WM_TRANSIENT_FOR, _XL_DMA_BUF_CREATED,
...
extern void	   XLFrameClockAfterFrame(FrameClock *,
	   void (*)(FrameClock *, void *, uint64_t), void *);
...
struct _XdgRoleImplementationFuncs {
	...
	void (*activate)(Role *, XdgRoleImplementation *, int, Time, Surface *);
...
extern void  XLGetXdgSurface(struct wl_client *, struct wl_resource *, uint32_t,
     struct wl_resource *);
...
extern void XLGetXdgPopup(struct wl_client *, struct wl_resource *, uint32_t,
...
extern Timer *AddTimer(void (*)(Timer *, void *, struct timespec), void *,
    struct timespec);
extern Timer *AddTimerWithBaseTime(void (*)(Timer *, void *, struct timespec),
    void *, struct timespec, struct timespec);
...
typedef struct wl_resource *(*CreateOfferFunc)(struct wl_client *, Timestamp);
...
extern void XLDataDeviceMakeOffers(Seat *, DndOfferFuncs, Surface *, int, int);
...
extern void   XLDispatchGEForSeats(XEvent *, Surface *, Subcompositor *);
...
extern void *XLSeatRunAfterResize(Seat *, void (*)(void *, void *), void *);
...
extern void	   XLSeatBeginDrag(Seat *, DataSource *, Surface *, Surface *,
	   uint32_t);
...
extern void XLSeatGetMouseData(Seat *, Surface **, double *, double *, double *,
    double *);
...
typedef ReadStatus (
    *GetDataFunc)(WriteTransfer *, unsigned char *, ptrdiff_t, ptrdiff_t *);
...
extern ReadTransfer *ConvertSelectionFuncs(Atom, Atom, Time, void *,
    void (*)(ReadTransfer *, Atom, int),
    void (*)(ReadTransfer *, Atom, int, ptrdiff_t),
    Bool (*)(ReadTransfer *, Bool));
extern void	    *GetTransferData(ReadTransfer *);
extern Time	     GetTransferTime(ReadTransfer *);

extern unsigned char *ReadChunk(ReadTransfer *, int, ptrdiff_t *, ptrdiff_t *);
extern void	      SkipChunk(ReadTransfer *);
extern void	      CompleteDelayedTransfer(ReadTransfer *);

extern Bool OwnSelection(Timestamp, Atom,
    GetDataFunc (*)(WriteTransfer *, Atom, Atom *), Atom *, int);
...
extern void ApplyInverseTransform(int, int, Matrix *, BufferTransform);
...
extern void XLPointerBarrierCheck(Seat *, Surface *, double, double, double,
    double);
...
extern void XLRelativePointerSendRelativeMotion(struct wl_resource *, uint64_t,
    double, double);
...
extern void XLGetTestSeat(struct wl_client *, struct wl_resource *, uint32_t);
...
extern SyncHelper *MakeSyncHelper(Subcompositor *, Window, RenderTarget,
    void (*)(void *, uint32_t), Role *);
