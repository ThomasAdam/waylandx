...
do_viewport_damage_test(double src_x, double src_y, double src_width,
    double src_height, int dest_width, int dest_height, const char *dump_1_name,
    const char *dump_2_name)
{
	...
	/* Set the viewport.  */
	wp_viewport_set_source(viewport, wl_fixed_from_double(src_x),
	    wl_fixed_from_double(src_y), wl_fixed_from_double(src_width),
